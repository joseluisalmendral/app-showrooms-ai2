...
export default function ShowroomDashboard() {
  ...
  const hasCompleteProfile = () => {
    ...
    // Verificar campos importantes para showroom
  ...
  // Obtener nombre del showroom desde la sesión usando la función mejorada
  const showroomName = getProfileName();
